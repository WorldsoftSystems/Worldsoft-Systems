...
if (strtotime($fecha) < strtotime($fecha_admision)) {
    ...
    $sql = "INSERT INTO medicacion_paci (id_paciente, medicamento, fecha, hora, dosis, cantidad, valor) VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('iissdid', $idPaciente, $desc, $fecha, $hora, $dosis, $cantidad, $valor);
