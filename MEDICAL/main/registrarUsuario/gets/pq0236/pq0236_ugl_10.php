...
if ($result->num_rows > 0) {
    ...
    $linea1 = "CABECERA\n";
    $linea2 = "30-58060423-0;;$fechaActual;$periodo;$inst;2;UP3058060423000;dnat4\n";
    ...
    $sqlBenefs = "SELECT DISTINCT p.*
                 ...
                 WHERE  (practs.fecha BETWEEN '$fechaInicio' AND '$fechaFin') AND p.obra_social = 4 AND p.ugl_paciente = 10
                 ";
...
ORDER BY VR.nombre ASC, pop.fecha DESC;  -- Ordenamos para ver las OP más recientes arriba
";
