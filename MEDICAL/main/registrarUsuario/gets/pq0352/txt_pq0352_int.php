...
if ($result->num_rows > 0) {
    ...
    $linea1 = "CABECERA\n";
    $linea2 = "30-66408967-6;;$fechaActual;$periodo;inst interd de salud mental sa;2;UP3066408967600;3qcfj\n";
...
";
    ...
    $response = array(
        'filename' => $c_interno . "_int_WSS.txt",  // Nombre dinámico del archivo
        'content' => $contenido
    );
