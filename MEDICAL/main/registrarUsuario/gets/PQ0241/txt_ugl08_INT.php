...
if ($result->num_rows > 0) {
    ...
    $linea1 = "CABECERA\n";
    $linea2 = "30-63207857-5;;$fechaActual;$periodo;$inst;2;UP30632078575N9;70724\n";
    ...
    $sqlBenefs = "SELECT DISTINCT p.*
                 ...
                 WHERE  (practs.fecha BETWEEN '$fechaInicio' AND '$fechaFin') AND p.obra_social = 4 AND p.ugl_paciente = 8 AND act.modalidad IN (11,12)
                 ";
...
";
    ...
    $response = array(
        'filename' => $c_interno . "_08_INT_WSS.txt",  // Nombre dinámico del archivo
        'content' => $contenido
    );
