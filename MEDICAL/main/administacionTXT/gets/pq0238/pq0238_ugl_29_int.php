...
if ($result->num_rows > 0) {
    ...
    $linea1 = "CABECERA\n";
    $linea2 = "30-65642500-4;;$fechaActual;$periodo;$inst;2;UP3065642500400;vtgg0\n";
    ...
    $sqlBenefs = "SELECT DISTINCT p.*
                 ...
                 WHERE  (practs.fecha BETWEEN '$fechaInicio' AND '$fechaFin') AND p.obra_social = 4 AND p.ugl_paciente = 29 AND act.modalidad IN (11,12)
                 ";
    ...
    $response = array(
        'filename' => $c_interno . "_29_INT_WSS.txt",  // Nombre dinámico del archivo
        'content' => $contenido
    );
