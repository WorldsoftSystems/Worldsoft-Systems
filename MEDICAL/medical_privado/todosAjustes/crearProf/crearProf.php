                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="matricula_p" name="matricula_p" required>
                                </div>
                                <div class="mb-3">
                                    <label for="matricula_n" class="form-label">Matrícula Nacional:</label>
                                    <input type="text" class="form-control" id="matricula_n" name="matricula_n" required>
                                </div>
