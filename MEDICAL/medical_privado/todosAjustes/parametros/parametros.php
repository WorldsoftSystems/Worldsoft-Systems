                ...
                <div class="modal-body">
                    <form id="formParametro" action="./agregarParametro.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="c_interno" name="c_interno" >
                        </div>

                        <div class="form-group">
                            <label for="c_pami">Código PAMI</label>
                            <input type="text" class="form-control" id="c_pami" name="c_pami" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="u_efect" name="u_efect" >
                        </div>

                        <div class="form-group">
                            <label for="clave_efect">Clave Efectores</label>
                            <input type="text" class="form-control" id="clave_efect" name="clave_efect" >
                        </div>

                        <div class="form-group">
                            <label for="num_hist_amb">Numero de Hist. AMB A Partir de :</label>
                            <input type="text" class="form-control" id="num_hist_amb" name="num_hist_amb" >
                        </div>

                        <div class="form-group">
                            <label for="num_hist_int">Numero de Hist. INT A Partir de :</label>
                            <input type="text" class="form-control" id="num_hist_int" name="num_hist_int" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="puerta" name="puerta" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="cod_sucursal" name="cod_sucursal" >
                        </div>
