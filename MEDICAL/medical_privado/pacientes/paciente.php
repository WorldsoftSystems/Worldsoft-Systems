...
<body>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <a href="#" class="btn btn-link" title="Control de pagos" data-bs-toggle="modal"
                            data-bs-target="#pagoPacienteModal" onclick="loadPagosPaciente()">
                            <i class="fa-solid fa-credit-card custom-icon"></i>
                            <span class="icon-text">Control de pagos</span>
                        </a>
    ...
    <!-- CONTROL DE PAGOS -->
    <div class="modal fade" id="pagoPacienteModal" tabindex="-1" aria-labelledby="pagoPacienteModalLabel"
        aria-hidden="true">

        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="pagoPacienteModalLabel">Pagos</h5>
                    <div class="modal-header-center">
                        <img src="../img/logo.png" alt="Logo" class="modal-logo">
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" id="addPagoPacienteModalBody">
                    <!-- Aquí se cargará el contenido del formulario de agregar práctica -->
                </div>
                <div class="modal-body" id="pagoPacienteModalBody">
                    <!-- Aquí se cargará el contenido del formulario -->
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <!-- Contenedor de la lista de prácticas -->
                        <div id="listaPagos" class="scrollable-content">
                            <!-- Aquí se cargará dinámicamente la lista de prácticas -->
                        </div>
                        <!-- Contenedor de la paginación -->
                        <div id="pagination" class="mt-3">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-volver">Volver</button>
                    <button type="button" class="btn btn-primary btn-custom-save" id="nuevoPago">Agregar</button>
                    <button type="button" class="btn btn-info" id="btnGenerarPDFPago">Generar PDF</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="agregarPagoModal" tabindex="-1" aria-labelledby="agregarPagoModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formAgregarPago" class="row g-3">
                        <input type="hidden" id="pagoIdPaciente" name="id_paciente">
                        <input type="hidden" name="id" id="pagoId">
                        <div class="col-md-4">
                            <label for="pagoNombreCarga" class="form-label">Nombre y Apellido</label>
                            <input type="text" class="form-control" id="pagoNombreCarga" name="pagoNombreCarga"
                                readonly>
                        </div>
                        <div class="col-md-4">
                            <label for="pagoFechas" class="form-label">Fechas</label>
                            <input type="date" class="form-control" id="pagoFechas" name="pagoFechas" required>
                        </div>
                        <div class="col-md-4">
                            <label for="pagoProfesional" class="form-label">Profesional</label>
                            <select class="form-control" id="pagoProfesional" name="pagoProfesional" required>
                                <option value="">Seleccionar...</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="pagoActividad" class="form-label">Actividad</label>
                            <select class="form-control" name="pagoActividad" id="pagoActividad">
                                <option value="">Seleccionar...</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label for="pagoCantidad" class="form-label">Cantidad Abonada</label>
                            <input type="number" class="form-control" id="pagoCantidad" name="pagoCantidad" required>
                        </div>

                        <div class="col-md-4">
                            <label for="pagoTotal" class="form-label">Total de la consulta</label>
                            <input type="number" class="form-control" id="pagoTotal" name="pagoTotal" required>
                        </div>

                        <div class="col-md-4">
                            <label for="pagoMetodo" class="form-label">Metodo de pago</label>
                            <input type="text" class="form-control" id="pagoMetodo" name="pagoMetodo">
                        </div>

                        <div class="col-md-4">
                            <label for="pagoObs" class="form-label">Observaciones</label>
                            <input type="text" class="form-control" id="pagoObs" name="pagoObs">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary btn-custom-save" id="btnGuardarPago">Guardar</button>
    ...
    <!-- Modal para seleccionar fechas -->
    <div class="modal fade" id="modalFechasPDF" tabindex="-1" aria-labelledby="modalFechasPDFLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalFechasPDFLabel">Seleccionar rango de fechas</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="formFechasPDF">
                        <div class="mb-3">
                            <label for="fechaDesdePago" class="form-label">Desde</label>
                            <input type="date" class="form-control" id="fechaDesdePago" name="fechaDesdePago" required>
                        </div>
                        <div class="mb-3">
                            <label for="fechaHastaPago" class="form-label">Hasta</label>
                            <input type="date" class="form-control" id="fechaHastaPago" name="fechaHastaPago" required>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" id="btnConfirmarPDF">Generar PDF</button>
                </div>
            </div>
        </div>
    </div>
