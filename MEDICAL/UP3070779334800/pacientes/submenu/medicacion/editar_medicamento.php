...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $dosis = $_POST['dosis'];
    // Convertir la dosis a un float para asegurarse de que se maneje como decimal
    $dosis = floatval($dosis); // Asegúrate de que sea un número decimal
    ...
    if (strtotime($fecha) < strtotime($fecha_admision)) {
        ...
        $stmt->bind_param("issdi", $desc, $fecha, $hora, $dosis, $id);
