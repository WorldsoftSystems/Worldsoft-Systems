...
$limit = 250; // Número de registros por página
$page = isset($_GET['page']) ? (int) $_GET['page'] : 1; // Página actual
$offset = ($page - 1) * $limit; // Calcular el desplazamiento

// Obtener las medicaciones con paginación
$sql = "SELECT * FROM medicacion ORDER BY descripcion ASC LIMIT $limit OFFSET $offset";
$result = $conn->query($sql);

// Obtener el total de registros para calcular el número total de páginas
$totalRecordsSql = "SELECT COUNT(*) as total FROM medicacion"; // Asegúrate de contar en la tabla correcta
...
<body>
    ...
    <div class="container">
        ...
        <nav aria-label="Page navigation">
            <div class="overflow-auto"> <!-- Contenedor con desplazamiento -->
