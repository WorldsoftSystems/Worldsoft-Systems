...
// Consulta para obtener los valores de 'dir' y 'localidad' desde 'parametro_sistema'
$sqlDireccion = "SELECT CONCAT(dir, ', ', localidad) AS direccion FROM parametro_sistema LIMIT 1";
$resultDireccion = $conn->query($sqlDireccion);

// Inicializar la variable direccion como vacío
$direccion = '';

if ($resultDireccion->num_rows > 0) {
    $direccionRow = $resultDireccion->fetch_assoc();
...
$sheet->setCellValue('J1', 'DIRECCION'); // Nueva columna
...
if ($resultado->num_rows > 0) {
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        $sheet->setCellValue('J' . $fila, $direccion); // Nueva columna de direccion
