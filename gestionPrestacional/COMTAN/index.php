...
<head>
    ...
    <title>Iniciar Sesión <?php echo htmlspecialchars($nombre); ?></title>  <!-- Aquí se concatena "Iniciar Sesión" + nombre -->
...
<body class="bg-gray-100 h-screen flex flex-col items-center justify-center">
    ...
    <div class="bg-white p-8 rounded shadow-md w-96">
        ...
        <h2 class="text-2xl font-bold mb-4">Iniciar Sesión <?php echo htmlspecialchars($nombre); ?></h2>
